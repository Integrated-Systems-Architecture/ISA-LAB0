...
def config():
    ...
    memory_ss = MemorySS()
    # 4 x 64 KiB = 256 KiB RAM. The default generic config (2 x 32 KiB) is too
    # small once X-HEEP links all device drivers + newlib heap into an app.
    memory_ss.add_ram_banks([64] * 4)
